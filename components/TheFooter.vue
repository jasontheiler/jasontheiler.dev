<template>
  <footer
    class="w-full px-4 pt-4 pb-8 bg-gray-100 dark:bg-gray-900 text-center transition-colors duration-150"
  >
    <div class="my-8">
      <a
    ...
    <p class="my-4">
      Made with
      <svg viewBox="0 0 20 20" fill="currentColor" class="w-6 h-6 mb-1 inline">
        <path
          fill-rule="evenodd"
