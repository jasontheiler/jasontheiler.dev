<template>
  <header
    class="fixed left-0 top-0 w-full h-16 z-50 border-b border-gray-200 dark:border-gray-900 bg-white dark:bg-black bg-opacity-75 dark:bg-opacity-75 bg-blur"
  >
    <div
